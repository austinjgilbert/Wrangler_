  ...
  fields: [
    ...
    { name: 'techStack', title: 'Tech Stack (legacy flat)', type: 'array', of: [{ type: 'string' }] },
    {
      ...
      fields: [
        ...
        { name: 'analytics', type: 'array', title: 'Analytics & Tag Management', of: [{ type: 'string' }] },
        { name: 'ecommerce', type: 'array', title: 'E-commerce Platforms', of: [{ type: 'string' }] },
        { name: 'hosting', type: 'array', title: 'Hosting / CDN / Infrastructure', of: [{ type: 'string' }] },
        { name: 'cssFrameworks', type: 'array', title: 'CSS Frameworks', of: [{ type: 'string' }] },
        { name: 'authProviders', type: 'array', title: 'Auth Providers', of: [{ type: 'string' }] },
        { name: 'searchTech', type: 'array', title: 'Search Technology', of: [{ type: 'string' }] },
        { name: 'monitoring', type: 'array', title: 'Monitoring / Observability', of: [{ type: 'string' }] },
        { name: 'payments', type: 'array', title: 'Payments', of: [{ type: 'string' }] },
        { name: 'marketing', type: 'array', title: 'Marketing Automation', of: [{ type: 'string' }] },
        { name: 'chat', type: 'array', title: 'Chat & Support', of: [{ type: 'string' }] },
        { name: 'cdnMedia', type: 'array', title: 'CDN & Media Optimization', of: [{ type: 'string' }] },
        ...
        { name: 'allDetected', type: 'array', title: 'All Detected (flat)', of: [{ type: 'object', fields: [{ name: 'name', type: 'string', title: 'Name' }, { name: 'category', type: 'string', title: 'Category' }] }] },
      ],
    },
    {
      name: 'technologies',
